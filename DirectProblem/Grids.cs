...
public class Grids
{
    ...
    public static Grid<Node2D> GetGridWith0Dot025StepWithElementCloseToWell()
    {
        var grid = GridBuilder
            .SetRAxis(new AxisSplitParameter(
                    new[] { 1e-4, 0.1, 1, 10 },
                    new UniformSplitter(4),
                    new StepProportionalSplitter(0.025, 1.05),
                    new StepProportionalSplitter(0.071, 1.05)
                )
            )
            .SetZAxis(new AxisSplitParameter(
                    new[] { -10d, -6d, -5d, -4d, 0d },
    ...
    public static Grid<Node2D> GetGridWith0Dot025StepWithElementNearToWell()
    {
        var grid = GridBuilder
            .SetRAxis(new AxisSplitParameter(
                    new[] { 1e-4, 0.1, 1, 2, 10 },
                    ...
                    new StepProportionalSplitter(0.025, 1.05),
                    new StepProportionalSplitter(0.071, 1.05),
                    new StepProportionalSplitter(0.125, 1.05)
                )
            )
            .SetZAxis(new AxisSplitParameter(
                    new[] { -10d, -6d, -5d, -4d, 0d },
    ...
    public static Grid<Node2D> GetGridWith0Dot025StepWithElementsCloseToWell()
    {
        var grid = GridBuilder
            .SetRAxis(new AxisSplitParameter(
                    new[] { 1e-4, 0.1, 1, 10 },
    ...
    public static Grid<Node2D> GetGridWith0Dot025StepWithElementsCloseToWellAndNearToWell()
    {
        var grid = GridBuilder
            .SetRAxis(new AxisSplitParameter(
                    new[] { 1e-4, 0.1, 1, 2, 10 },
